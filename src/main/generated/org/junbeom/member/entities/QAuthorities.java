...
public class QAuthorities extends EntityPathBase<Authorities> {
    ...
    private static final long serialVersionUID = -326913388L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QAuthorities authorities = new QAuthorities("authorities");

    public final EnumPath<org.junbeom.member.constants.Authority> authority = createEnum("authority", org.junbeom.member.constants.Authority.class);
